...
tex = sprite_get_texture(argument3,0),
width = argument4,
height = argument5,
col = argument6,
alpha = argument7,
...
draw_vertex_texture_colour(x1,y1,0,0,col,alpha * mid_alpha);
draw_vertex_texture_colour(x2,y1,0,1,col,alpha * mid_alpha);
draw_vertex_texture_colour(x1,y2,1,0,col,alpha * mid_alpha);
draw_vertex_texture_colour(x2,y2,1,1,col,alpha * mid_alpha);
draw_primitive_end();
